...
TIFMissileNuke01 = Class(TIFMissileNuke) {
    ...
    InitialEffects = {'/effects/emitters/nuke_munition_launch_trail_02_emit.bp',
					  '/mods/Firey Explosion Mod/hook/effects/Emitters/tnuketake.bp',
	},
    LaunchEffects = {
		...
		'/mods/Firey Explosion Mod/hook/effects/Emitters/tnuketrail.bp',
		'/mods/Firey Explosion Mod/hook/effects/Emitters/tnukelense.bp',
    },
    ThrustEffects = {'/effects/emitters/nuke_munition_launch_trail_04_emit.bp',
    				...
    				## '/mods/Firey Explosion Mod/hook/effects/Emitters/tnuketrailc.bp',
