...
CIFEMPFluxWarhead04 = Class(CEMPFluxWarheadProjectile) {
    ...
    InitialEffects = {'/effects/emitters/nuke_munition_launch_trail_02_emit.bp',
					  '/mods/Firey Explosion Mod/hook/effects/Emitters/cnukelense.bp',
					  '/mods/Firey Explosion Mod/hook/effects/Emitters/cnuketakes.bp',
	},
    LaunchEffects = {'/effects/emitters/nuke_munition_launch_trail_03_emit.bp',
					 '/mods/Firey Explosion Mod/hook/effects/Emitters/cnuketrails.bp',},
