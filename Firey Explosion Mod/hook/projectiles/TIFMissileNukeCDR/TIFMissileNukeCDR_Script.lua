...
TIFMissileNukeCDR = Class(TIFMissileNuke) {
    ...
    InitialEffects = {'/effects/emitters/nuke_munition_launch_trail_02_emit.bp',
					  '/mods/Firey Explosion Mod/hook/effects/Emitters/tnuketakes.bp',
	},
    LaunchEffects = {
        '/effects/emitters/nuke_munition_launch_trail_03_emit.bp',
        '/effects/emitters/nuke_munition_launch_trail_05_emit.bp',
		'/mods/Firey Explosion Mod/hook/effects/Emitters/tnukelenses.bp',
		'/mods/Firey Explosion Mod/hook/effects/Emitters/tnuketrails.bp',
    },
