...
# Emitter Values
    FxInitial = {},
    TrailDelay = 1,
    FxTrails = EffectTemplate.TAAMissileTrail,    #{'/effects/emitters/missile_sam_munition_trail_01_emit.bp',},
    FxTrailOffset = -0.5,
...
TMissileCruiseProjectile = Class(SingleBeamProjectile) {
    ...
    FxTrails = EffectTemplate.TTactMissileTrail,
    FxTrailOffset = -1,
...
TMissileProjectile = Class(SingleBeamProjectile) {
    FxTrails = EffectTemplate.TTactMissileTrail, #{'/effects/emitters/missile_munition_trail_01_emit.bp',}
    FxTrailOffset = -1,
    BeamName = '/effects/emitters/missile_munition_exhaust_beam_01_emit.bp',
